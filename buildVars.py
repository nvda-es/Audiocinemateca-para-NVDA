...
addon_info = {
	...
	"addon_name": "audiocinemateca",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Audiocinemateca para NVDA"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("Toda la Audiocinemateca en nuestro NVDA"),
	# version
	"addon_version": "1.0",
	# Author(s)
	"addon_author": u"Héctor J. Benítez Corredera <xebolax@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/nvda-es/audiocinemateca-para-nvda",
...
pythonSources = [os.path.join("addon", "globalPlugins", "Audiocinemateca", "*.py"), os.path.join("addon", "globalPlugins", "Audiocinemateca", "app", "*.py"), os.path.join("addon", "globalPlugins", "Audiocinemateca", "app", "lib", "*.py")]
